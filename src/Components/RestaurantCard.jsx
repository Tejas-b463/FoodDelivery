...
const RestaurantCard = (props) =>{
  ...
  <div className="max-w-xs rounded-lg hover:shadow-2xl p-2">
       <div className="h-72 w-full relative">
          ...
          <span className="absolute bg-gradient-to-t from-black bottom-0 p-3 w-full font-black text-stone-50 text-xl ">{resData?.info?.aggregatedDiscountInfoV3?.discountTag} {resData?.info?.aggregatedDiscountInfoV3?.header }</span>
       </div>
