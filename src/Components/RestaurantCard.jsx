...
const RestaurantCard = (props) =>{
  ...
  <div className="w-[17rem] rounded-lg hover:shadow-2xl p-2">
      ...
      <div className="py-4">
           <h4 className="px-2 overflow-hidden text-lg w-ellipis whitespace-nowrap  leading-tight ">{name}</h4>
           <p className="px-2 overflow-hidden text-ellipsis whitespace-nowrap w-[76%] leading-tight text-gray-500">{cuisines.join(", ")}</p>
           <div className="flex justify-between items-center ">
            <h4 className="bg-green-700 text-white rounded-lg m-2 p-2 flex items-center gap-1">{avgRating}<PiStarThin/> </h4>
            <div className="p-2">
            <p className="leading-tight text-[rgb(0,0,0,0.7)] text"> {costForTwo}</p>
