  ...
  return (
    <div className="w-[17rem]  rounded-lg hover:shadow-2xl p-2">
      ...
      <div className="py-4 ">
        ...
        <p className="px-2 overflow-hidden text-ellipsis whitespace-nowrap w-[76%] leading-tight text-[rgb(0,0,0,0.7)]">
          {cuisines.join(", ")}
        </p>
        <div className="flex justify-between items-center ">
          <h4 className="bg-green-600 text-white rounded-lg m-2 p-2">
            {avgRating}
          </h4>
          <div className="p-2">
