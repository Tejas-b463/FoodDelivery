  ...
  return (
    <div className="">
      {cartItems.length == cartItems || (
        <button
          className="my-4 p-2 border border-red-500 text-red-500 rounded hover:bg-red-500 hover:text-white"
      ...
      {cartItems.length === 0 && (
        <div className=" flex my-10  flex-wrap justify-center">
          <img
            ...
            alt=""
          />
          <div className="text-2xl text-gray-600 mx-16 my-20 leading-10">
            <p> Oops! Your cart is empty. </p>
            <p className=""> Hungry? Start adding delicious items </p>
            <Link className="py-2 text-blue-500 underline text-xl" to="/">
              Explore
            </Link>
          </div>
        </div>
