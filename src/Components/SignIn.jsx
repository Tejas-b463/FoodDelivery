    ...
    <div>
      {user ? (
        <div className="mt-10 mb-[4rem] p-4">
          <h1 className="text-center text-2xl font-bold ml-4 leading-loose">
            Welcome, {user.displayName} 🚀
          </h1>
          <p className="text-center text-gray-500  ml-4 leading-loose">
            {user.email}
          </p>
          <div className="flex justify-center my-4">
            <button
              className="text-lg border border-red-400 px-10 py-1 font-bold text-red-500 hover:bg-red-500 hover:text-white"
              onClick={signOut}
            >
              {" "}
              Sign Out
        ...
        <div className="text-center mt-10 mb-[4rem] p-4">
          <h2 className="text-2xl font-bold ml-4 leading-loose">
