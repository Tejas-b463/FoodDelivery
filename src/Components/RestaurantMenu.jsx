...
const RestaurantMenu = () => {
  ...
  return (
    <div className="">
      <div className="my-6 p-2 mx-2 flex items-center justify-center gap-x-96 text-left">
        <div className="flex-wrap">
          ...
          <div>
            ...
            <p className="text-sm text-[rgb(0,0,0,0.6)]">
              {areaName}, {city}
            </p>
          </div>
        </div>
        <div className="">
          <h6 className="bg-green-600 flex text-white py-2 px-1 rounded-lg items-center m-1">
            <ImStarEmpty className="mx-1" />
            {avgRating}
          </h6>
      ...
      {/* Offers */}
      <div className=" ml-96 p-2 w-[740px] border-t-2 border-gray-200">
        <ScrollingCarousel>
          {offerCards?.map((offer) => (
            <div
              className="px-4 my-4 border p-3 rounded-lg mx-2"
              key={offer?.info?.id}
            >
