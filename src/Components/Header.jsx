          ...
          <div>
            ...
            <div className="">
               <div className="px-4 text-lg">
                <Link className="flex items-center gap-1.5" onClick={toggleMenu}>
                ...
                <p className="font-[500] text-lg">Sign In</p>
                </Link>
                {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-end">
          <div className="bg-white w-[30rem] h-full shadow-lg transition-all duration-300 ease-in-out">
            <div className="p-4">
              {/* Menu content goes here */}
              <RxCross2 className="text-3xl font-bold cursor-pointer " onClick={closeMenu}/>
              <div className="mt-4">
                {/* Login form */}
                <h1 className="text-3xl font-[500]">Login</h1>
            </div>
            </div>
