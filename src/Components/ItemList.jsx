...
const ItemList = ({items}) =>{
  ...
  const toPay = (totalItem  + platFormFee);
     ...
     <div className="flex  justify-center my-12">
      <div className="mx-12">
          {items && items.map(item=> <div key={item.card.info.id} className="flex my-12"> 
         ...
         <div className="mx-12 py-4  h-96 bg-white shadow px-20 my-12 ">
          ...
          {/* Total Amount */}
          <div className="flex items-center  justify-between border-t-2 my-2  border-[rgba(0,0,0,0.7)]">
