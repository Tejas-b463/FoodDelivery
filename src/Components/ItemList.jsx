...
const ItemList = ({ items }) => {
  ...
  const totalItem =
    items.length > 0
      ? items
          .map((bill) =>
            bill.card.info.price > 0
              ? bill.card.info.price / 100
              : bill.card.info.defaultPrice / 100
          )
      ...
      {items.length == items || (
        <div className=" bg-white shadow mx-56 p-10">
          ...
          <div className="flex items-center justify-between my-2">
            ...
            <p className="py-2 text-[rgba(0,0,0,0.7)] pl-4">
              ₹{totalItem.toFixed(0)}
            </p>
          </div>
          {/* Delivery Time */}
          ...
          <div className="flex items-center my-2  justify-between ">
            ...
            <div className="flex items-center py-2 pl-4">
              ...
              <p className="px-2 text-[rgba(0,0,0,0.7)]">
